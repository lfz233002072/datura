...
import datura.sys.entity.SysHibernateUtil;
...
//    private String pkName = null;
    ...
    public HibernateBasicDao() {
        ...
        this.entityClass = (Class<M>) getClass();//(Class<M>) ((ParameterizedType) getClass().getGenericSuperclass()).getActualTypeArguments()[0];
