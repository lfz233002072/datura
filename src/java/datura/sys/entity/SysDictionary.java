...
public class SysDictionary  implements java.io.Serializable {
    ...
    public SysDictionary(String id, String description, String rootId, String parentId, Integer dataSort, Byte delFlag, Integer visitLevel, String visitPath, String name, String shortName, String code, String ruleExpression, Integer customField1, String customField2, String customField3, Byte hasChild) {
       this.id = id;
